...
def execute(train_configs):
    ...
    NuM_OF_EPOCHS = train_configs[CONFIG_KEYS.NUMBER_OF_EPOCHS]
    MAX_NUM_OF_FREEZED_LAYERS = train_configs[CONFIG_KEYS.NUM_OF_FREEZED_LAYERS_MAX]
    MIN_NUM_OF_FREEZED_LAYERS = (
        train_configs[CONFIG_KEYS.NUM_OF_FREEZED_LAYERS_MIN]) - 1
    MODEL_TYPE_CLASS = train_configs[CONFIG_KEYS.MODEL_TYPE_CLASS]
    MODEL_TYPE_BASE_NAME = train_configs[CONFIG_KEYS.MODEL_TYPE_BASE_NAME]
    SHOULD_LOAD_FROM_CHECKPOINT = train_configs[CONFIG_KEYS.SHOULD_LOAD_FROM_CHECKPOINT]
    CHECKPOINT_NAME = train_configs[CONFIG_KEYS.CHECKPOINT_NAME]
    TRAIN_DATASET_DIR = train_configs[CONFIG_KEYS.DATASET_PATH]
    OUTPUT_MODEL_PREFIX = train_configs[CONFIG_KEYS.OUTPUT_MODEL_PREFIX]
